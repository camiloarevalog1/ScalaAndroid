...
public class FragmentEntregado extends Fragment {
     ...
     * @return A new instance of fragment FragmentEntregado.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentEntregado newInstance(String param1, String param2) {
        FragmentEntregado fragment = new FragmentEntregado();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.fragment_fragment_entregado, container, false);

        productos= new ArrayList<>();
        recyclerViewPersonajes=(RecyclerView)vista.findViewById(R.id.recycler);
